...
1. Invokes `Aouda.Server create-admin --email ... --password-stdin --data ...` as a subprocess, piping the password on stdin (no HTTP required — writes directly to the data directory).
